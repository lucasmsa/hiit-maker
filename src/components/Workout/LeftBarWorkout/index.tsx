...
import { CollapsedArrowContainer, CollapsedArrowLeft, CollapsedArrowRight, CollapsedContainer, CollapsedContainerWrapper, HeaderWorkout, WorkoutContainer } from './styles'
