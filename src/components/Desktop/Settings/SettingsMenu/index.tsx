...
const SettingsMenu = () => {
  const trainingDefaultValues = useSelector(getTrainingDefaultValues, shallowEqual) as any;
      ...
      <SettingsConfigurationOptionContainer>
        ...
        <TimeInput
          ...
          onFocusOut={(event: any) => {
            const { value: onFocusOutValue } = event.target;
          ...
          onChange={(event: ChangeEvent<HTMLInputElement>) => {
            const { value: onChangeValue } = event.target;
            const configurationLabel = configurationValues[highlightedText];
            if (isNaN(+onChangeValue)) return;
            return setNewTrainingDefaultValues((oldState) => ({
              ...oldState,
              [configurationLabel]: onChangeValue
            }));
          }}
        />
      </SettingsConfigurationOptionContainer>
    ...
    <Container>
      <ConfirmChangesModal
        ...
        setLastTrainingDefaultValues={(newDefaultValues) =>
          setLastTrainingDefaultValues(newDefaultValues as any)
        }
