...
import { ReactComponent as ConnectingLineSvg } from '../../../../assets/images/midSection/connecting-line.svg';
...
export const ConnectingLineWithDotContainer = styled.div`
  display: flex;
  flex-direction: column;
...
export const ConnectingLine = styled(ConnectingLineSvg)`
  align-self: center;
`;
